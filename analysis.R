...
####################################
## Build Bowtie2 Index
system("bowtie2-build ./data/Macaca_mulatta.1.73.fa ./data/bowtie2index/Macaca_mulatta.1.73")
...
source("~/Projects/IlhemMessaoudi/RNA-Seq/systemPipe.R")
bampaths <- runTophat(tophatargs=tophatargs, runid="01")

## Submit to compute nodes
source("~/Projects/IlhemMessaoudi/RNA-Seq/systemPipe.R")
(joblist <- qsubRun(appfct="runTophat(appargs, runid)", appargs=tophatargs, qsubargs=qsubargs, Nqsubs=6, submitdir="/bigdata/tgirke/Projects/IlhemMessaoudi/RNA-Seq/results", myfct="~/Projects/IlhemMessaoudi/RNA-Seq/systemPipe.R"))
