...
The \Robject{targets} file defines all FASTQ files and sample comparisons of the analysis workflow. The following shows the format of a sample \Robject{targets} file provided by this package. 
...
\noindent Construct \Robject{SYSargs} object from param and targets files 
<<eval=TRUE, keep.source=TRUE>>=
