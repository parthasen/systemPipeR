...
@
Comparisons are defined in the header lines of the \Robject{targets} starting with '\# <CMP>'. The 
...
\subsection{Alignement with Bowtie 2 (here for miRNA profiling experiment)}
