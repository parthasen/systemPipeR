...
This report describes the analysis of an ChIP-Seq project from Dr. First Last's lab which studies the gene expression changes of ... in \textit{Organism XYZ}. The experimental design is as follows...
