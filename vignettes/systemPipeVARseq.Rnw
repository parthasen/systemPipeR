...
This report describes the analysis of an VAR-Seq project from Dr. First Last's lab which studies the genetic variances of ... in \textit{Organism x}. The experimental design is as follows...
